    ...
    <div>
      ...
      <div className='container'>
        ...
        >
          ...
          <p>
            <Link to='/'>
              <Button variant='primary'>Why IT Technologies</Button>
            </Link>{' '}
          </p>
        </Jumbotron>
      </div>
              ...
              >
                <MDBCol className='py-5'>
                  ...
                  <p className='mx-5 mb-5'>
                    ...
                    partnership with medical device MSP programs over an
                    extended period of time in all capacities of temporary,
                    temporary to permanent and permanent positions.
                  </p>
                  <Link to='/'>
                    <MDBBtn
                      outline
              ...
              >
                <MDBCol className='py-5'>
                  ...
                  <p className='mx-5 mb-5'>
                    ...
                    profession that takes kindly to the uninitiated and decades
                    of experience are often needed where another field requires
                    far less. The very same applies to insurance recruiting and
                    an agency must be aware of both the industry’s needs, and
